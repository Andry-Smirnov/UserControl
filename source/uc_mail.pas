...
begin
  ...
  ('<html> <head> <title>Inclus�o de Senha</title> <style type="text/css"> <!-- body { 	margin-left: 0px; '
    ...
    + #13#10 + '<body> <p>Aten��o: <br>Senha criada com sucesso:</p>' +
  ...
  UserAdded.FTitle := 'Inclus�o de usu�rio';
  ...
  ('<html> <head> <title>Altera��o de Senha</title> <style type="text/css"> <!-- body { 	margin-left: 0px; '
    ...
    #13#10 + '<p>Atenciosamente,</p>' + #13#10 +
    '<p>Administrador do sistema</p></body></html>');
  SendEmailUserChanged.FTitle := 'Altera��o de usu�rio';
  ...
  ('<html> <head> <title>Altera��o de Senha</title> <style type="text/css"> <!-- body { 	margin-left: 0px; '
    ...
    #13#10 + '<p>Atenciosamente,</p>' + #13#10 +
    '<p>Administrador do sistema</p></body></html>');
  PasswordForgotten.FTitle := 'Altera��o de Senha';
  ...
  ('<html> <head> <title>Altera��o de Senha</title> <style type="text/css"> <!-- body { 	margin-left: 0px; '
    ...
    #13#10 + '<p>Atenciosamente,</p>' + #13#10 +
    '<p>Administrador do sistema</p></body></html>');
  PasswordChanged.FTitle := 'Altera��o de senha';
    ...
    begin
      try
        ...
        if SendEmailTp(Name, Login, NewPassword, Email, Profile, PasswordForgotten) = True then
          ...
          MessageDlg('N�o foi possivel enviar nova senha', mtInformation, [mbOK], 0);
      except
      end;
    end;
end;
