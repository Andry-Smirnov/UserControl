...
begin
  with DestSettings.CommonMessages do
    begin
      ...
      if MaxLoginAttemptsError = '' then
        MaxLoginAttemptsError := ChangeLanguage(ucEnglish, 'Const_Men_MaxTentativas');
      ...
      if ForcaTrocaSenha = '' then
        ForcaTrocaSenha := ChangeLanguage(ucEnglish, 'Const_ErrPass_ForcaTrocaSenha');
    end;
  ...
  with DestSettings.UsersForm do
    begin
      ...
      if PromptDelete_WindowCaption = '' then
        PromptDelete_WindowCaption := ChangeLanguage(ucEnglish, 'Const_Cad_ConfirmaDelete_WindowCaption');
      // added by fduenas
    end;
  ...
  with DestSettings.UsersProfile do
    begin
      ...
      if PromptDelete_WindowCaption = '' then
        PromptDelete_WindowCaption := ChangeLanguage(ucEnglish, 'Const_Prof_ConfirmaDelete_WindowCaption');
      // added by fduenas
    end;
  ...
  with DestSettings.ChangePassword do
    begin
      ...
      if LabelCurrentPassword = '' then
        LabelCurrentPassword := ChangeLanguage(ucEnglish, 'Const_Troc_LabelSenhaAtual');
  ...
  with DestSettings.CommonMessages.ChangePasswordError do
    begin
      if InvalidCurrentPassword = '' then
        InvalidCurrentPassword := ChangeLanguage(ucEnglish, 'Const_ErrPass_SenhaAtualInvalida');
      if NewPasswordError = '' then
        NewPasswordError := ChangeLanguage(ucEnglish, 'Const_ErrPass_ErroNovaSenha');
      if NewEqualCurrent = '' then
        NewEqualCurrent := ChangeLanguage(ucEnglish, 'Const_ErrPass_NovaIgualAtual');
      if PasswordRequired = '' then
        PasswordRequired := ChangeLanguage(ucEnglish, 'Const_ErrPass_SenhaObrigatoria');
      if MinPasswordLength = '' then
        MinPasswordLength := ChangeLanguage(ucEnglish, 'Const_ErrPass_SenhaMinima');
      if InvalidNewPassword = '' then
        InvalidNewPassword := ChangeLanguage(ucEnglish, 'Const_ErrPass_SenhaInvalida');
    end;
  ...
  with DestSettings.Log do
    begin
      ...
      if PromptDelete_WindowCaption = '' then
        PromptDelete_WindowCaption := ChangeLanguage(ucEnglish, 'Const_LogC_ConfirmaDelete_WindowCaption');
      // added by fduenas
  ...
  with DestSettings.AppMessages do
    begin
      ...
      if MsgsForm_WindowCaption = '' then
        MsgsForm_WindowCaption := ChangeLanguage(ucEnglish, 'Const_Msgs_WindowCaption');
      ...
      if MsgsForm_PromptDelete = '' then
        MsgsForm_PromptDelete := ChangeLanguage(ucEnglish, 'Const_Msgs_PromptDelete');
      if MsgsForm_PromptDelete_WindowCaption = '' then
        MsgsForm_PromptDelete_WindowCaption := ChangeLanguage(ucEnglish, 'Const_Msgs_PromptDelete_WindowCaption');
      if MsgsForm_NoMessagesSelected = '' then
        MsgsForm_NoMessagesSelected := ChangeLanguage(ucEnglish, 'Const_Msgs_NoMessagesSelected');
      if MsgsForm_NoMessagesSelected_WindowCaption = '' then
        MsgsForm_NoMessagesSelected_WindowCaption := ChangeLanguage(ucEnglish, 'Const_Msgs_NoMessagesSelected_WindowCaption');
      if MsgRec_BtClose = '' then
        MsgRec_BtClose := ChangeLanguage(ucEnglish, 'Const_MsgRec_BtClose');
      if MsgRec_WindowCaption = '' then
        MsgRec_WindowCaption := ChangeLanguage(ucEnglish, 'Const_MsgRec_WindowCaption');
      ...
      if MsgRec_LabelSubject = '' then
        MsgRec_LabelSubject := ChangeLanguage(ucEnglish, 'Const_MsgRec_LabelSubject');
      if MsgRec_LabelMessage = '' then
        MsgRec_LabelMessage := ChangeLanguage(ucEnglish, 'Const_MsgRec_LabelMessage');
      ...
      if MsgSend_WindowCaption = '' then
        MsgSend_WindowCaption := ChangeLanguage(ucEnglish, 'Const_MsgSend_WindowCaption');
      ...
      if MsgSend_GroupMessage = '' then
        MsgSend_GroupMessage := ChangeLanguage(ucEnglish, 'Const_MsgSend_GroupMessage');
      if MsgSend_LabelSubject = '' then
        MsgSend_LabelSubject := ChangeLanguage(ucEnglish, 'Const_MsgSend_LabelSubject'); // added by fduenas
      if MsgSend_LabelMessageText = '' then
        MsgSend_LabelMessageText := ChangeLanguage(ucEnglish, 'Const_MsgSend_LabelMessageText'); // added by fduenas
    end;
  ...
  with DestSettings.UsersLogged do
    begin
      ...
      if LabelDescricao = '' then
        LabelDescricao := ChangeLanguage(ucEnglish, 'Const_UserLogged_LabelDescricao');
...
begin
  with DestSettings.CommonMessages do
    begin
      if BlankPassword = '' then
        BlankPassword := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_SenhaDesabitada');
      if PasswordChanged = '' then
        PasswordChanged := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_SenhaAlterada');
      if InitialMessage.Text = '' then
        InitialMessage.Text := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_MsgInicial');
      if MaxLoginAttemptsError = '' then
        MaxLoginAttemptsError := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_MaxTentativas');
      if InvalidLogin = '' then
        InvalidLogin := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_LoginInvalido');
      if InactiveLogin = '' then
        InactiveLogin := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_LoginInativo');
      if AutoLogonError = '' then
        AutoLogonError := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_AutoLogonError');
      if UsuarioExiste = '' then
        UsuarioExiste := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_UsuarioExiste');
      if PasswordExpired = '' then
        PasswordExpired := ChangeLanguage(DestSettings.fLanguage, 'Const_Men_PasswordExpired');
      if ForcaTrocaSenha = '' then
        ForcaTrocaSenha := ChangeLanguage(DestSettings.fLanguage, 'Const_ErrPass_ForcaTrocaSenha');
    end;
  ...
  with DestSettings.Login do
    begin
      ...
      if LabelPassword = '' then
        LabelPassword := ChangeLanguage(DestSettings.fLanguage, 'Const_Log_LabelSenha');
      if LabelUser = '' then
        LabelUser := ChangeLanguage(DestSettings.fLanguage, 'Const_Log_LabelUsuario');
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Log_WindowCaption');

      if LabelTentativa = '' then
        LabelTentativa := ChangeLanguage(DestSettings.fLanguage, 'Const_Log_LabelTentativa');
      if LabelTentativas = '' then
        LabelTentativas := ChangeLanguage(DestSettings.fLanguage, 'Const_Log_LabelTentativas');
  ...
  with DestSettings.UsersForm do
    begin
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Cad_WindowCaption');
      if LabelDescription = '' then
        LabelDescription := ChangeLanguage(DestSettings.fLanguage, 'Const_Cad_LabelDescricao');
      if ColName = '' then
      ...
      if BtRights = '' then
        BtRights := ChangeLanguage(DestSettings.fLanguage, 'Const_Cad_BtPermissoes');
      if BtPassword = '' then
      ...
      if PromptDelete = '' then
        PromptDelete := ChangeLanguage(DestSettings.fLanguage, 'Const_Cad_ConfirmaExcluir');
      if PromptDelete_WindowCaption = '' then
        PromptDelete_WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Cad_ConfirmaDelete_WindowCaption');
    end;

  with DestSettings.UsersProfile do
    begin
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Prof_WindowCaption');
      if LabelDescription = '' then
        LabelDescription := ChangeLanguage(DestSettings.fLanguage, 'Const_Prof_LabelDescricao');
      if ColProfile = '' then
        ColProfile := ChangeLanguage(DestSettings.fLanguage, 'Const_Prof_ColunaNome');
      if BtAdd = '' then
      ...
      if BtRights = '' then
        BtRights := ChangeLanguage(DestSettings.fLanguage, 'Const_Prof_BtPermissoes');
      if BtClose = '' then
        BtClose := ChangeLanguage(DestSettings.fLanguage, 'Const_Prof_BtFechar');
      if PromptDelete = '' then
        PromptDelete := ChangeLanguage(DestSettings.fLanguage, 'Const_Prof_ConfirmaExcluir');
      if PromptDelete_WindowCaption = '' then
        PromptDelete_WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Prof_ConfirmaDelete_WindowCaption');
      // added by fduenas
    end;
  ...
  with DestSettings.AddChangeUser do
    begin
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_WindowCaption');
      if LabelAdd = '' then
        LabelAdd := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_LabelAdicionar');
      if LabelChange = '' then
        LabelChange := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_LabelAlterar');
      if LabelName = '' then
        LabelName := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_LabelNome');
      if LabelLogin = '' then
        LabelLogin := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_LabelLogin');
      if LabelEmail = '' then
        LabelEmail := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_LabelEmail');
      if CheckPrivileged = '' then
        CheckPrivileged := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_CheckPrivilegiado');
      if BtSave = '' then
      ...
      if LabelPerfil = '' then
        LabelPerfil := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_LabelPerfil');

      if CheckExpira = '' then
        CheckExpira := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_CheckEspira');
      if Day = '' then
      ...
      if LabelStatus = '' then
        LabelStatus := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_LabelStatus');
      if StatusActive = '' then
        StatusActive := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_StatusActive');

      if StatusDisabled = '' then
        StatusDisabled := ChangeLanguage(DestSettings.fLanguage, 'Const_Inc_StatusDisabled');
    end;

  with DestSettings.AddChangeProfile do
    begin
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_PInc_WindowCaption');
      if LabelAdd = '' then
        LabelAdd := ChangeLanguage(DestSettings.fLanguage, 'Const_PInc_LabelAdicionar');
      if LabelChange = '' then
        LabelChange := ChangeLanguage(DestSettings.fLanguage, 'Const_PInc_LabelAlterar');
      if LabelName = '' then
  ...
  with DestSettings.Rights do
    begin
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Perm_WindowCaption');
      if LabelUser = '' then
        LabelUser := ChangeLanguage(DestSettings.fLanguage, 'Const_Perm_LabelUsuario');
      if LabelProfile = '' then
        LabelProfile := ChangeLanguage(DestSettings.fLanguage, 'Const_Perm_LabelPerfil');
      if PageMenu = '' then
        PageMenu := ChangeLanguage(DestSettings.fLanguage, 'Const_Perm_PageMenu');
      if PageActions = '' then
        PageActions := ChangeLanguage(DestSettings.fLanguage, 'Const_Perm_PageActions');
      if PageControls = '' then
        PageControls := ChangeLanguage(DestSettings.fLanguage, 'Const_Perm_PageControls'); // by vicente barros leonel
      if BtUnlock = '' then
  ...
  with DestSettings.ChangePassword do
    begin
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Troc_WindowCaption');
      if LabelDescription = '' then
        LabelDescription := ChangeLanguage(DestSettings.fLanguage, 'Const_Troc_LabelDescricao');
      if LabelCurrentPassword = '' then
        LabelCurrentPassword := ChangeLanguage(DestSettings.fLanguage, 'Const_Troc_LabelSenhaAtual');
      if LabelNewPassword = '' then
        LabelNewPassword := ChangeLanguage(DestSettings.fLanguage, 'Const_Troc_LabelNovaSenha');
      if LabelConfirm = '' then
        LabelConfirm := ChangeLanguage(DestSettings.fLanguage, 'Const_Troc_LabelConfirma');
      if BtSave = '' then
  ...
  with DestSettings.CommonMessages.ChangePasswordError do
    begin
      if InvalidCurrentPassword = '' then
        InvalidCurrentPassword := ChangeLanguage(DestSettings.fLanguage, 'Const_ErrPass_SenhaAtualInvalida');
      if NewPasswordError = '' then
        NewPasswordError := ChangeLanguage(DestSettings.fLanguage, 'Const_ErrPass_ErroNovaSenha');
      if NewEqualCurrent = '' then
        NewEqualCurrent := ChangeLanguage(DestSettings.fLanguage, 'Const_ErrPass_NovaIgualAtual');
      if PasswordRequired = '' then
        PasswordRequired := ChangeLanguage(DestSettings.fLanguage, 'Const_ErrPass_SenhaObrigatoria');
      if MinPasswordLength = '' then
        MinPasswordLength := ChangeLanguage(DestSettings.fLanguage, 'Const_ErrPass_SenhaMinima');
      if InvalidNewPassword = '' then
        InvalidNewPassword := ChangeLanguage(DestSettings.fLanguage, 'Const_ErrPass_SenhaInvalida');
    end;

  with DestSettings.ResetPassword do
    begin
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_DefPass_WindowCaption');
      if LabelPassword = '' then
        LabelPassword := ChangeLanguage(DestSettings.fLanguage, 'Const_DefPass_LabelSenha');
    end;

  with DestSettings.Log do
    begin
      if WindowCaption = '' then
        WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_WindowCaption');
      if LabelDescription = '' then
        LabelDescription := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_LabelDescricao');
      if LabelUser = '' then
        LabelUser := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_LabelUsuario');
      if LabelDate = '' then
        LabelDate := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_LabelData');
      if LabelLevel = '' then
        LabelLevel := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_LabelNivel');
      if ColLevel = '' then
        ColLevel := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_ColunaNivel');
      if ColAppID = '' then
        ColAppID := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_ColunaAppID');
      if ColMessage = '' then
        ColMessage := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_ColunaMensagem');
      if ColUser = '' then
        ColUser := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_ColunaUsuario');
      if ColDate = '' then
      ...
      if PromptDelete = '' then
        PromptDelete := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_ConfirmaExcluir');
      if PromptDelete_WindowCaption = '' then
        PromptDelete_WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_ConfirmaDelete_WindowCaption');
      // added by fduenas
      if OptionUserAll = '' then
      ...
      // added by fduenas
      if OptionLevelNormal = '' then
        OptionLevelNormal := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_Normal'); // added by fduenas
      if OptionLevelHigh = '' then
        OptionLevelHigh := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_High');
      // added by fduenas
      if OptionLevelCritic = '' then
        OptionLevelCritic := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_Critic'); // added by fduenas
      if DeletePerformed = '' then
        DeletePerformed := ChangeLanguage(DestSettings.fLanguage, 'Const_LogC_ExcluirEfectuada'); // added by fduenas
    end;

  with DestSettings.AppMessages do
    begin
      if MsgsForm_BtNew = '' then
        MsgsForm_BtNew := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_BtNew');
      if MsgsForm_BtReplay = '' then
        MsgsForm_BtReplay := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_BtReplay');
      if MsgsForm_BtForward = '' then
        MsgsForm_BtForward := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_BtForward');
      if MsgsForm_BtDelete = '' then
        MsgsForm_BtDelete := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_BtDelete');
      if MsgsForm_BtClose = '' then
        MsgsForm_BtClose := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_BtClose'); // added by fduenas
      if MsgsForm_WindowCaption = '' then
        MsgsForm_WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_WindowCaption');
      if MsgsForm_ColFrom = '' then
        MsgsForm_ColFrom := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_ColFrom');
      if MsgsForm_ColSubject = '' then
        MsgsForm_ColSubject := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_ColSubject');
      if MsgsForm_ColDate = '' then
        MsgsForm_ColDate := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_ColDate');
      if MsgsForm_PromptDelete = '' then
        MsgsForm_PromptDelete := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_PromptDelete');
      if MsgsForm_PromptDelete_WindowCaption = '' then
        MsgsForm_PromptDelete_WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_PromptDelete_WindowCaption'); // added by fduenas
      if MsgsForm_NoMessagesSelected = '' then
        MsgsForm_NoMessagesSelected := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_NoMessagesSelected');
      // added by fduenas
      if MsgsForm_NoMessagesSelected_WindowCaption = '' then
        MsgsForm_NoMessagesSelected_WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_NoMessagesSelected_WindowCaption'); // added by fduenas
      if MsgRec_BtClose = '' then
        MsgRec_BtClose := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgRec_BtClose');
      if MsgRec_WindowCaption = '' then
        MsgRec_WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgRec_WindowCaption');
      if MsgRec_Title = '' then
        MsgRec_Title := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgRec_Title');
      if MsgRec_LabelFrom = '' then
        MsgRec_LabelFrom := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgRec_LabelFrom');
      if MsgRec_LabelDate = '' then
        MsgRec_LabelDate := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgRec_LabelDate');
      if MsgRec_LabelSubject = '' then
        MsgRec_LabelSubject := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgRec_LabelSubject');
      if MsgRec_LabelMessage = '' then
        MsgRec_LabelMessage := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgRec_LabelMessage');
      if MsgSend_BtSend = '' then
        MsgSend_BtSend := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_BtSend');
      if MsgSend_BtCancel = '' then
        MsgSend_BtCancel := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_BtCancel');
      if MsgSend_WindowCaption = '' then
        MsgSend_WindowCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_WindowCaption');
      if MsgSend_Title = '' then
        MsgSend_Title := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_Title');
      if MsgSend_GroupTo = '' then
        MsgSend_GroupTo := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_GroupTo');
      if MsgSend_RadioUser = '' then
        MsgSend_RadioUser := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_RadioUser');
      if MsgSend_RadioAll = '' then
        MsgSend_RadioAll := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_RadioAll');
      if MsgSend_GroupMessage = '' then
        MsgSend_GroupMessage := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_GroupMessage');
      if MsgSend_LabelSubject = '' then
        MsgSend_LabelSubject := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_LabelSubject'); // added by fduenas
      if MsgSend_LabelMessageText = '' then
        MsgSend_LabelMessageText := ChangeLanguage(DestSettings.fLanguage, 'Const_MsgSend_LabelMessageText');
      // added by fduenas
    end;
  ...
  with DestSettings.UsersLogged do
    begin
      if BtnMessage = '' then
        BtnMessage := ChangeLanguage(DestSettings.fLanguage, 'Const_UserLogged_BtnMsg');
      if BtnRefresh = '' then
        BtnRefresh := ChangeLanguage(DestSettings.fLanguage, 'Const_UserLogged_Refresh');
      if Btnclose = '' then
        Btnclose := ChangeLanguage(DestSettings.fLanguage, 'Const_Msgs_BtClose');
      if LabelDescricao = '' then
        LabelDescricao := ChangeLanguage(DestSettings.fLanguage, 'Const_UserLogged_LabelDescricao');
      if LabelCaption = '' then
        LabelCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_UserLogged_LabelCaption');
      if ColName = '' then
        ColName := ChangeLanguage(DestSettings.fLanguage, 'Const_Cad_ColunaNome');
      if ColLogin = '' then
        ColLogin := ChangeLanguage(DestSettings.fLanguage, 'Const_Cad_ColunaLogin');
      if ColComputer = '' then
        ColComputer := ChangeLanguage(DestSettings.fLanguage, 'Const_CadColuna_Computer');
      if ColData = '' then
        ColData := ChangeLanguage(DestSettings.fLanguage, 'Const_CadColuna_Data');
      if InputCaption = '' then
        InputCaption := ChangeLanguage(DestSettings.fLanguage, 'Const_UserLogged_InputCaption');
      if InputText = '' then
        InputText := ChangeLanguage(DestSettings.fLanguage, 'Const_UserLogged_InputText');
      if MsgSystem = '' then
        MsgSystem := ChangeLanguage(DestSettings.fLanguage, 'Const_UserLogged_MsgSystem');
    end;
end;
...
begin
  with DestSettings.CommonMessages do
    begin
      BlankPassword := ChangeLanguage(DestSettings.Language, 'Const_Men_SenhaDesabitada');
      PasswordChanged := ChangeLanguage(DestSettings.Language, 'Const_Men_SenhaAlterada');
      InitialMessage.Text := ChangeLanguage(DestSettings.Language, 'Const_Men_MsgInicial');
      MaxLoginAttemptsError := ChangeLanguage(DestSettings.Language, 'Const_Men_MaxTentativas');
      InvalidLogin := ChangeLanguage(DestSettings.Language, 'Const_Men_LoginInvalido');
      InactiveLogin := ChangeLanguage(DestSettings.Language, 'Const_Men_LoginInativo');
      AutoLogonError := ChangeLanguage(DestSettings.Language, 'Const_Men_AutoLogonError');
      UsuarioExiste := ChangeLanguage(DestSettings.Language, 'Const_Men_UsuarioExiste');
      PasswordExpired := ChangeLanguage(DestSettings.Language, 'Const_Men_PasswordExpired');
    end;
  ...
  with DestSettings.Login do
    begin
      ...
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Log_WindowCaption');
      LabelTentativa := ChangeLanguage(DestSettings.Language, 'Const_Log_LabelTentativa');
      LabelTentativas := ChangeLanguage(DestSettings.Language, 'Const_Log_LabelTentativas');
    end;

  with DestSettings.UsersForm do
    begin
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Cad_WindowCaption');
      LabelDescription := ChangeLanguage(DestSettings.Language, 'Const_Cad_LabelDescricao');
      ...
      PromptDelete := ChangeLanguage(DestSettings.Language, 'Const_Cad_ConfirmaExcluir');
      PromptDelete_WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Cad_ConfirmaDelete_WindowCaption');
    end;

  with DestSettings.UsersProfile do
    begin
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Prof_WindowCaption');
      LabelDescription := ChangeLanguage(DestSettings.Language, 'Const_Prof_LabelDescricao');
      ...
      PromptDelete := ChangeLanguage(DestSettings.Language, 'Const_Prof_ConfirmaExcluir');
      PromptDelete_WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Prof_ConfirmaDelete_WindowCaption');
    end;

  with DestSettings.AddChangeUser do
    begin
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Inc_WindowCaption');
      ...
      CheckPrivileged := ChangeLanguage(DestSettings.Language, 'Const_Inc_CheckPrivilegiado');
      ...
      StatusDisabled := ChangeLanguage(DestSettings.Language, 'Const_Inc_StatusDisabled');
    end;

  with DestSettings.AddChangeProfile do
    begin
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_PInc_WindowCaption');
  ...
  with DestSettings.Rights do
    begin
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Perm_WindowCaption');
      ...
      PageControls := ChangeLanguage(DestSettings.Language, 'Const_Perm_PageControls');
  ...
  with DestSettings.ChangePassword do
    begin
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Troc_WindowCaption');
      LabelDescription := ChangeLanguage(DestSettings.Language, 'Const_Troc_LabelDescricao');
      LabelCurrentPassword := ChangeLanguage(DestSettings.Language, 'Const_Troc_LabelSenhaAtual');
      LabelNewPassword := ChangeLanguage(DestSettings.Language, 'Const_Troc_LabelNovaSenha');
      LabelConfirm := ChangeLanguage(DestSettings.Language, 'Const_Troc_LabelConfirma');
  ...
  with DestSettings.CommonMessages.ChangePasswordError do
    begin
      InvalidCurrentPassword := ChangeLanguage(DestSettings.Language, 'Const_ErrPass_SenhaAtualInvalida');
      NewPasswordError := ChangeLanguage(DestSettings.Language, 'Const_ErrPass_ErroNovaSenha');
      NewEqualCurrent := ChangeLanguage(DestSettings.Language, 'Const_ErrPass_NovaIgualAtual');
      PasswordRequired := ChangeLanguage(DestSettings.Language, 'Const_ErrPass_SenhaObrigatoria');
      MinPasswordLength := ChangeLanguage(DestSettings.Language, 'Const_ErrPass_SenhaMinima');
      InvalidNewPassword := ChangeLanguage(DestSettings.Language, 'Const_ErrPass_SenhaInvalida');
    end;

  with DestSettings.ResetPassword do
    begin
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_DefPass_WindowCaption');
      LabelPassword := ChangeLanguage(DestSettings.Language, 'Const_DefPass_LabelSenha');
    end;

  with DestSettings.Log do
    begin
      WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_LogC_WindowCaption');
      LabelDescription := ChangeLanguage(DestSettings.Language, 'Const_LogC_LabelDescricao');
      ...
      ColMessage := ChangeLanguage(DestSettings.Language, 'Const_LogC_ColunaMensagem');
      ...
      PromptDelete := ChangeLanguage(DestSettings.Language, 'Const_LogC_ConfirmaExcluir');
      PromptDelete_WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_LogC_ConfirmaDelete_WindowCaption');
      ...
      DeletePerformed := ChangeLanguage(DestSettings.Language, 'Const_LogC_ExcluirEfectuada');
    end;

  with DestSettings.AppMessages do
    begin
      MsgsForm_BtNew := ChangeLanguage(DestSettings.Language, 'Const_Msgs_BtNew');
      MsgsForm_BtReplay := ChangeLanguage(DestSettings.Language, 'Const_Msgs_BtReplay');
      MsgsForm_BtForward := ChangeLanguage(DestSettings.Language, 'Const_Msgs_BtForward');
      MsgsForm_BtDelete := ChangeLanguage(DestSettings.Language, 'Const_Msgs_BtDelete');
      MsgsForm_BtClose := ChangeLanguage(DestSettings.Language, 'Const_Msgs_BtClose');
      // added by fduenas
      MsgsForm_WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Msgs_WindowCaption');
      MsgsForm_ColFrom := ChangeLanguage(DestSettings.Language, 'Const_Msgs_ColFrom');
      MsgsForm_ColSubject := ChangeLanguage(DestSettings.Language, 'Const_Msgs_ColSubject');
      MsgsForm_ColDate := ChangeLanguage(DestSettings.Language, 'Const_Msgs_ColDate');
      MsgsForm_PromptDelete := ChangeLanguage(DestSettings.Language, 'Const_Msgs_PromptDelete');
      MsgsForm_PromptDelete_WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Msgs_PromptDelete_WindowCaption');
      // added by fduenas
      MsgsForm_NoMessagesSelected := ChangeLanguage(DestSettings.Language, 'Const_Msgs_NoMessagesSelected');
      // added by fduenas
      MsgsForm_NoMessagesSelected_WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_Msgs_NoMessagesSelected_WindowCaption'); // added by fduenas
      MsgRec_BtClose := ChangeLanguage(DestSettings.Language, 'Const_MsgRec_BtClose');
      MsgRec_WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_MsgRec_WindowCaption');
      MsgRec_Title := ChangeLanguage(DestSettings.Language, 'Const_MsgRec_Title');
      MsgRec_LabelFrom := ChangeLanguage(DestSettings.Language, 'Const_MsgRec_LabelFrom');
      MsgRec_LabelDate := ChangeLanguage(DestSettings.Language, 'Const_MsgRec_LabelDate');
      MsgRec_LabelSubject := ChangeLanguage(DestSettings.Language, 'Const_MsgRec_LabelSubject');
      MsgRec_LabelMessage := ChangeLanguage(DestSettings.Language, 'Const_MsgRec_LabelMessage');
      MsgSend_BtSend := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_BtSend');
      MsgSend_BtCancel := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_BtCancel');
      MsgSend_WindowCaption := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_WindowCaption');
      MsgSend_Title := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_Title');
      MsgSend_GroupTo := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_GroupTo');
      MsgSend_RadioUser := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_RadioUser');
      MsgSend_RadioAll := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_RadioAll');
      MsgSend_GroupMessage := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_GroupMessage');
      MsgSend_LabelSubject := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_LabelSubject'); // added by fduenas
      MsgSend_LabelMessageText := ChangeLanguage(DestSettings.Language, 'Const_MsgSend_LabelMessageText');
      // added by fduenas
    end;
  ...
  with DestSettings.UsersLogged do
    begin
      ...
      LabelDescricao := ChangeLanguage(DestSettings.Language, 'Const_UserLogged_LabelDescricao');
      LabelCaption := ChangeLanguage(DestSettings.Language, 'Const_UserLogged_LabelCaption');
      ColName := ChangeLanguage(DestSettings.Language, 'Const_Cad_ColunaNome');
      ColLogin := ChangeLanguage(DestSettings.Language, 'Const_Cad_ColunaLogin');
      ColComputer := ChangeLanguage(DestSettings.Language, 'Const_CadColuna_Computer');
      ColData := ChangeLanguage(DestSettings.Language, 'Const_CadColuna_Data');
      InputCaption := ChangeLanguage(DestSettings.Language, 'Const_UserLogged_InputCaption');
      InputText := ChangeLanguage(DestSettings.Language, 'Const_UserLogged_InputText');
      MsgSystem := ChangeLanguage(DestSettings.Language, 'Const_UserLogged_MsgSystem');
    end;
end;
