...
begin
  ...
  TPasswordForm(FormSenha).Position := FUsercontrol.UserSettings.WindowsPosition;
  ...
  Begin
    ...
    (*
      ...
      FDataSetCadastroUsuario.FieldByName('LOGIN').AsString,
      TPasswordForm(FormSenha).edtSenha.Text ,
    ...
    *)
    FUsercontrol.ChangePassword(FDataSetCadastroUsuario.FieldByName('IDUser')
      .AsInteger, TPasswordForm(FormSenha).edtSenha.Text);
  End;
...
begin
  ...
  begin
    ...
    if FUsercontrol.CurrentUser.Username <>
      FUsercontrol.Login.InitialLogin.User then
