...
const
  S_PORTUGALBR: array [0 .. MaxArray, 0 .. 1] of utf8string = (
    ...
    ('Const_Men_MsgInicial', 'ATENÇÃO Login Inicial:' + #13 + #10 + #13 + #10 + 'Usuário : :user' +
    #13 + #10 + 'Senha : :password' + #13 + #10 + #13 + #10 +
    'Defina as permissões para este usuário.'),
    ('Const_Men_MaxTentativas', '%d Tentativas de login inválido. Por motivos de segurança o ' +
    #13 + #10 + 'sistema será fechado.'),
...
const
  S_ENGLISH: array [0 .. MaxArray, 0 .. 1] of utf8string =
    ...
    ('Const_Men_MsgInicial', 'ATTENTION, Inicial Login :' + #13 + #10 + #13 + #10 + 'User: :user' +
...
const
  S_RUSSIAN: array [0 .. MaxArray, 0 .. 1] of utf8string =
    (('Const_Contr_TitleLabel', 'Team of Components of the Form. :'),
    ('Const_Contr_GroupLabel', 'Группа:'),
    ('Const_Contr_CompDispLabel', 'Доступные компоненты:'),
    ('Const_Contr_CompSelLabel', 'Выбранные компоненты:'),
    ('Const_Contr_BtOK', '&OK'),
    ('Const_Contr_BTCancel', '&Отмена'),
    ('Const_Contr_DescCol', 'Описаниие'),
    ('Const_Contr_BtSellAllHint', 'Выбрать все'),
    ('Const_Contr_BtSelHint', 'Выбрать'),
    ('Const_Contr_BtUnSelHint', 'Отменить выбор'),
    ('Const_Contr_BtUnSelAllHint', 'Отменить выбор всех'),
    ('Const_Msgs_BtNew', '&Новое сообщение'),
    ('Const_Msgs_BtReplay', '&Ответить'),
    ('Const_Msgs_BtForward', '&Переслать'),
    ('Const_Msgs_BtDelete', '&Удалить'),
    ('Const_Msgs_BtClose', '&Закрыть'),
    ('Const_Msgs_WindowCaption', 'Системное сообщение'),
    ('Const_Msgs_ColFrom', 'От'),
    ('Const_Msgs_ColSubject', 'Тема'),
    ('Const_Msgs_ColDate', 'Дата'),
    ('Const_Msgs_PromptDelete', 'It confirms exclusion of the selected messages?'),
    ('Const_Msgs_PromptDelete_WindowCaption', 'Удалить сообщения'),
    ('Const_Msgs_NoMessagesSelected', 'Нет выделенных сообщений'),
    ('Const_Msgs_NoMessagesSelected_WindowCaption', 'Информация'),
    ('Const_MsgRec_BtClose', '&Закрыть'),
    ('Const_MsgRec_WindowCaption', 'Сообщение'),
    ('Const_MsgRec_Title', 'Принятое сообщение'),
    ('Const_MsgRec_LabelFrom', 'От:'),
    ('Const_MsgRec_LabelDate', 'Дата'),
    ('Const_MsgRec_LabelSubject', 'Тема'),
    ('Const_MsgRec_LabelMessage', 'Сообщение'),
    ('Const_MsgSend_BtSend', '&Отправить'),
    ('Const_MsgSend_BtCancel', '&Отмена'),
    ('Const_MsgSend_WindowCaption', 'Сообщение'),
    ('Const_MsgSend_Title', 'Send New Message'),
    ('Const_MsgSend_GroupTo', 'Кому'),
    ('Const_MsgSend_RadioUser', 'Пользователь:'),
    ('Const_MsgSend_RadioAll', 'Все'),
    ('Const_MsgSend_GroupMessage', 'Сообщение'),
    ('Const_MsgSend_LabelSubject', 'Тема'),
    ('Const_MsgSend_LabelMessageText', 'Текст сообщения'),
    ('MsgExceptConnection', 'Done not informed the Connection, Transaction or Database component %s'),
    ('MsgExceptTransaction', 'Done not informed the Transaction component %s'),
    ('MsgExceptDatabase', 'Done not informed the Database do component %s'),
    ('MsgExceptPropriedade', 'Inform the property %s'),
    ...
    ('Const_Men_SenhaAlterada', 'Password altered with success!'),
    ('Const_Men_MsgInicial', 'ATTENTION, Inicial Login :' + #13 + #10 + #13 + #10 + 'User: :user' +
    #13 + #10 + 'Password : :password ' + #13 + #10 + #13 + #10 + 'Define the permissions for this user.'),
    ('Const_Men_MaxTentativas', '%d Attempts of login invalid. By reasons of security the system will be closed.'),
    ('Const_Men_LoginInvalido', 'User invalids or password !'),
    ('Const_Men_UsuarioExiste', 'The User "%s" is already set up in the system !!'),
    ('Const_Men_PasswordExpired', 'Attention, his sign died, favor exchanges it '),
    ...
    ('Const_Prof_LabelDescricao', 'Users profile '),
    ('Const_Prof_ColunaNome', 'Profile'),
    ('Const_Prof_BtAdicionar', '&Добавить'),
    ('Const_Prof_BtAlterar', 'A&lter'),
    ('Const_Prof_BtExcluir', '&Удалить'),
    ('Const_Prof_BtPermissoes', 'Д&оступ'),
    ('Const_Prof_BtSenha', '&Пароль'),
    ('Const_Prof_BtFechar', '&Закрыть'),
    ('Const_Prof_ConfirmaExcluir', 'There are users with the profile  "%s". Confirm erase ?'),
    ('Const_Prof_ConfirmaDelete_WindowCaption', 'Delete profile'),
    ('Const_Inc_WindowCaption', 'Users register '),
    ('Const_Inc_LabelAdicionar', 'Добавить пользователя'),
    ('Const_Inc_LabelAlterar', 'Изменить пользователя'),
    ('Const_Inc_LabelNome', 'Имя:'),
    ('Const_Inc_LabelLogin', 'Логин:'),
    ('Const_Inc_LabelEmail', 'E-mail:'),
    ('Const_Inc_LabelPerfil', 'Profile :'),
    ('Const_Inc_CheckPrivilegiado', 'Privileged user '),
    ('Const_Inc_BtGravar', '&Save'),
    ('Const_Inc_BtCancelar', 'Cancel'),
    ...
    ('Const_TableUsersLogged_FieldData', 'UCData'),
    ('Const_TableUsersLogged_TableName', 'UCTabUsersLogged'),
    ('Const_Evento_Insert', 'Вставить'),
    ('Const_Evento_Delete', 'Удалить'),
    ('Const_Evento_Edit', 'Редактировать'),
    ('Const_Evento_NewRecord', 'Новая запись'),
    ('Const_Hist_All', 'Все'),
    ('Const_Msg_LimpHistorico', 'Clean table history ?'),
    ('Const_Msg_MensConfirma', 'Подтвердить'),
    ('Const_Msg_LogEmptyHistory', 'User %s erase table history in %s'),
    ('Const_LabelDescricao', 'Мстория таблиц'),
    ('Const_LabelUser', 'Пользователь'),
    ('Const_LabelForm', 'Form'),
    ('Const_LabelEvento', 'Event'),
    ('Const_LabelTabela', 'Таблица'),
    ('Const_LabelDataEvento', 'Дата'),
    ('Const_LabelHoraEvento', 'Время'),
    ('Const_Msg_NewRecord', '%s insert new record'),
    ('Const_Hist_TableName', 'UCTABHistory'),
    ('Const_Hist_FieldApplicationID', 'ApplicationID'),
    ('Const_Hist_FieldUserID', 'UserID'),
    ...
    ('Const_Hist_FieldTableName', 'tName'),
    ('Const_Hist_MsgExceptPropr', 'Inform the property %s'),
    ('Const_Hist_BtnFiltro', '&Применить фильтр'),
    ('Const_Hist_BtnExcluir', '&Удалить историю'),
    ('Const_Hist_BtnFechar', '&Закрыть'),
    ('Const_UserLogged_BtnMsg', '&Сообщение'),
    ('Const_UserLogged_Refresh', '&Обновить'),
    ('Const_UserLogged_LabelDescricao', 'Активные пользователи'),
    ('Const_UserLogged_LabelCaption', 'Активные пользователи в системе'),
    ('Const_CadColuna_Computer', 'Компьютер'),
    ('Const_CadColuna_Data', 'Дата'),
    ('Const_UserLogged_InputCaption', 'Сообщение'),
    ('Const_UserLogged_InputText', 'Введите сообщение'),
    ('Const_UserLogged_MsgSystem', 'Системное сообщение'),
    ('Const_Men_LoginInativo', 'Inactive login'),
    ('Const_Inc_LabelStatus', 'Статус'),
    ('Const_Inc_StatusActive', 'Активный'),
    ('Const_Inc_StatusDisabled', 'Отключен'),

    ('Const_Version', 'Версия')
  );


function ChangeLanguage(Language: TUCLanguage; Prop: string): string;
