...
begin
  edtTableUsers.Text := ChangeLanguage(FUserControl.Language, 'Const_TableUsers_TableName');
  edtTableRights.Text := ChangeLanguage(FUserControl.Language, 'Const_TableRights_TableName');
end;
