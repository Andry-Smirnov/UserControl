...
type
  TUCLanguage = (ucPortuguesBr, ucEnglish, ucSpanish, ucFrench, ucRussian);

const
  MaxArray = 227;

const
  S_PORTUGALBR: array [0 .. MaxArray, 0 .. 1] of utf8string = (('Const_Contr_TitleLabel',
...
const
  S_ENGLISH: array [0 .. MaxArray, 0 .. 1] of utf8string =
    (('Const_Contr_TitleLabel', 'Team of Components of the Form. :'),
    ('Const_Contr_GroupLabel', 'Group:'), ('Const_Contr_CompDispLabel',
    'Available components:'), ('Const_Contr_CompSelLabel', 'Selected components:'),
    ('Const_Contr_BtOK', '&OK'), ('Const_Contr_BTCancel', '&Cancel'),
    ('Const_Contr_DescCol', 'Description'), ('Const_Contr_BtSellAllHint', 'Select All'),
    ('Const_Contr_BtSelHint', 'Select'), ('Const_Contr_BtUnSelHint', 'Unselect'),
    ...
    ('Const_MsgRec_BtClose', '&Close'), ('Const_MsgRec_WindowCaption', 'Message'),
    ('Const_MsgRec_Title', 'Received message'), ('Const_MsgRec_LabelFrom', 'From:'),
    ('Const_MsgRec_LabelDate', 'Date'), ('Const_MsgRec_LabelSubject', 'Subject'),
    ('Const_MsgRec_LabelMessage', 'Message'), ('Const_MsgSend_BtSend', '&Send'),
    ('Const_MsgSend_BtCancel', '&Cancel'), ('Const_MsgSend_WindowCaption', 'Message'),
    ('Const_MsgSend_Title', 'Send New Message'), ('Const_MsgSend_GroupTo', 'To'),
    ('Const_MsgSend_RadioUser', 'User:'), ('Const_MsgSend_RadioAll', 'All'),
    ('Const_MsgSend_GroupMessage', 'Message'), ('Const_MsgSend_LabelSubject', 'Subject'),
    ...
    ('Const_Log_LabelSenha', 'Password :'), ('Const_Log_LabelUsuario', 'User :'),
    ('Const_Log_WindowCaption', 'Login'), ('Const_Log_LbEsqueciSenha',
    'I forgot the password'), ('Const_Log_MsgMailSend',
    'The password was sent for his email .'), ('Const_Log_LabelTentativa', 'Attempt : '),
    ('Const_Log_LabelTentativas', 'Max of Attempts: '),
    ('Const_LogC_WindowCaption', 'Security'), ('Const_LogC_LabelDescricao',
    'Log of system'), ('Const_LogC_LabelUsuario', 'User :'),
    ('Const_LogC_LabelData', 'Date :'), ('Const_LogC_LabelNivel', 'Least level:'),
    ('Const_LogC_ColunaAppID', 'AppID'), ('Const_LogC_ColunaNivel', 'Level '),
    ('Const_LogC_ColunaMensagem', 'Message'), ('Const_LogC_ColunaUsuario', 'User'),
    ...
    ('Const_Prof_BtExcluir', '&Delete'), ('Const_Prof_BtPermissoes', 'A&ccesses'),
    ('Const_Prof_BtSenha', '&Password'), ('Const_Prof_BtFechar', '&Close'),
    ('Const_Prof_ConfirmaExcluir',
    'There are users with the profile  "%s". Confirm erase ?'),
    ('Const_Prof_ConfirmaDelete_WindowCaption', 'Delete profile'),
    ('Const_Inc_WindowCaption', 'Users register '),
    ('Const_Inc_LabelAdicionar', 'Add User'), ('Const_Inc_LabelAlterar', 'Change User'),
    ...
    ('Const_PInc_LabelNome', 'Description :'), ('Const_PInc_BtGravar', '&Save'),
    ('Const_PInc_BtCancelar', 'Cancel'), ('Const_Perm_WindowCaption', 'Security'),
    ('Const_Perm_LabelUsuario', 'Permissions of the User :'),
    ('Const_Perm_LabelPerfil', 'Permissions of the Profile  :'),
    ('Const_Perm_PageMenu', 'Items of the Menu'), ('Const_Perm_PageActions', 'Actions'),
    ('Const_Perm_PageControls', 'Controls'), ('Const_Perm_BtLibera', '&Release'),
    ('Const_Perm_BtBloqueia', '&Block'), ('Const_Perm_BtGravar', '&Save'),
    ('Const_Perm_BtCancelar', '&Cancel'), ('Const_Troc_WindowCaption', 'Security'),
    ('Const_Troc_LabelDescricao', 'Change Password'),
    ('Const_Troc_LabelSenhaAtual', 'Password :'),
    ('Const_Troc_LabelNovaSenha', 'New Password :'),
    ('Const_Troc_LabelConfirma', 'Confirmation :'), ('Const_Troc_BtGravar', '&Save'),
    ('Const_Troc_BtCancelar', 'Cancel'), ('Const_ErrPass_SenhaAtualInvalida',
    'Current password does not tally!'), ('Const_ErrPass_ErroNovaSenha',
    ...
    ('Const_Hist_All', 'All'), ('Const_Msg_LimpHistorico', 'Clean table history ?'),
    ('Const_Msg_MensConfirma', 'Confirm'), ('Const_Msg_LogEmptyHistory',
    'User %s erase table history in %s'), ('Const_LabelDescricao', 'History of Tables'),
    ('Const_LabelUser', 'User'), ('Const_LabelForm', 'Form'),
    ('Const_LabelEvento', 'Event'), ('Const_LabelTabela', 'Table'),
    ('Const_LabelDataEvento', 'Date'), ('Const_LabelHoraEvento', 'Time'),
    ('Const_Msg_NewRecord', '%s insert new record'),
    ('Const_Hist_TableName', 'UCTABHistory'),
    ('Const_Hist_FieldApplicationID', 'ApplicationID'),
    ('Const_Hist_FieldUserID', 'UserID'), ('Const_Hist_FieldEventDate', 'EventDate'),
    ('Const_Hist_FieldEventTime', 'EventTime'), ('Const_Hist_FieldForm', 'Form'),
    ...
    ('Const_Hist_BtnExcluir', '&Erase History'), ('Const_Hist_BtnFechar', '&Close'),
    ('Const_UserLogged_BtnMsg', '&Message'), ('Const_UserLogged_Refresh', '&Refresh'),
    ...
    ('Const_Men_LoginInativo', 'Inactive login'), ('Const_Inc_LabelStatus', 'Status'),
    ('Const_Inc_StatusActive', 'Active'), ('Const_Inc_StatusDisabled', 'Disabled'));

  { ------------------------------------------------------------------------------ }

const
  S_SPANISH: array [0 .. MaxArray, 0 .. 1] of utf8string =
    ...
    ('Const_Contr_BTCancel', '&Cancelar'), ('Const_Contr_DescCol', 'Descripción'),
    ...
    ('Const_Msgs_BtNew', '&Nuevo Mensaje'), ('Const_Msgs_BtReplay', '&Responder'),
    ('Const_Msgs_BtForward', '&Reenviar'), ('Const_Msgs_BtDelete', '&Borrar'),
    ('Const_Msgs_BtClose', '&Cerrar'), ('Const_Msgs_WindowCaption',
    'Mensajes de Sistema'), ('Const_Msgs_ColFrom', 'Remitente'),
    ('Const_Msgs_ColSubject', 'Asunto'), ('Const_Msgs_ColDate', 'Fecha'),
    ...
    ('Const_MsgRec_BtClose', '&Cerrar'), ('Const_MsgRec_WindowCaption', 'Mensaje'),
    ('Const_MsgRec_Title', 'Mensaje Recibido'), ('Const_MsgRec_LabelFrom', 'De:'),
    ('Const_MsgRec_LabelDate', 'Fecha'), ('Const_MsgRec_LabelSubject', 'Asunto'),
    ('Const_MsgRec_LabelMessage', 'Mensaje'), ('Const_MsgSend_BtSend', '&Enviar'),
    ('Const_MsgSend_BtCancel', '&Cancelar'), ('Const_MsgSend_WindowCaption', 'Mensaje'),
    ('Const_MsgSend_Title', 'Enviar Nuevo Mensaje'),
    ('Const_MsgSend_GroupTo', 'Para:'), ('Const_MsgSend_RadioUser', 'Usuario:'),
    ('Const_MsgSend_RadioAll', 'Todos'), ('Const_MsgSend_GroupMessage', 'Mensaje'),
    ('Const_MsgSend_LabelSubject', 'Asunto'), ('Const_MsgSend_LabelMessageText',
    'Texto del mensaje'), ('MsgExceptConnection',
    ...
    ('Const_Log_LabelSenha', 'Contraseña:'), ('Const_Log_LabelUsuario', 'Usuario: '),
    ('Const_Log_WindowCaption', 'Conección'), ('Const_Log_LbEsqueciSenha',
    'Olvidé mi Contraseña'), ('Const_Log_MsgMailSend',
    'La contraseña fue enviada a su correo.'), ('Const_Log_LabelTentativa',
    'Tentativa : '), ('Const_Log_LabelTentativas', 'Máximo de Tentativas : '),
    ('Const_LogC_WindowCaption', 'Seguridad'), ('Const_LogC_LabelDescricao',
    'Visor de Eventos'), ('Const_LogC_LabelUsuario', 'Usuario:'),
    ('Const_LogC_ColunaAppID', 'AppID'), ('Const_LogC_LabelData', 'Fecha:'),
    ('Const_LogC_LabelNivel', 'Nivel Mínimo: '), ('Const_LogC_ColunaNivel', 'Nivel'),
    ('Const_LogC_ColunaMensagem', 'Mensaje'), ('Const_LogC_ColunaUsuario', 'Usuario'),
    ('Const_LogC_ColunaData', 'Fecha'), ('Const_LogC_BtFiltro', '&Aplicar Filtro'),
    ('Const_LogC_BtExcluir', '&Borrar Bitácora'), ('Const_LogC_BtFechar', '&Cerrar'),
    ('Const_LogC_ConfirmaExcluir',
    ...
    ('Const_Cad_ColunaNome', 'Nombre'), ('Const_Cad_ColunaLogin', 'Usuario'),
    ('Const_Cad_ColunaEmail', 'Correo'), ('Const_Cad_BtAdicionar', '&Nuevo'),
    ('Const_Cad_BtAlterar', '&Editar'), ('Const_Cad_BtExcluir', 'E&liminar'),
    ('Const_Cad_BtPermissoes', '&Accesos'), ('Const_Cad_BtSenha', 'C&ontraseña'),
    ...
    ('Const_Prof_ColunaNome', 'Perfil'), ('Const_Prof_BtAdicionar', '&Nuevo'),
    ('Const_Prof_BtAlterar', '&Editar'), ('Const_Prof_BtExcluir', 'E&liminar'),
    ('Const_Prof_BtPermissoes', '&Accesos'), ('Const_Prof_BtSenha', 'C&ontraseña'),
    ...
    ('Const_Inc_LabelAlterar', 'Editar Usuario'), ('Const_Inc_LabelNome', 'Nombre:'),
    ...
    ('Const_PInc_LabelNome', 'Descripción: '), ('Const_PInc_BtGravar', '&Guardar'),
    ('Const_PInc_BtCancelar', 'Cancelar'), ('Const_Perm_WindowCaption', 'Seguridad'),
    ...
    ('Const_Perm_PageActions', 'Acciones'), ('Const_Perm_PageControls', 'Controles'),
    ('Const_Perm_BtLibera', '&Permitir'), ('Const_Perm_BtBloqueia', '&Bloquear'),
    ('Const_Perm_BtGravar', '&Guardar'), ('Const_Perm_BtCancelar', '&Cancelar'),
    ...
    ('Const_Evento_Edit', 'Editar'), ('Const_Evento_NewRecord', 'Nuevo registro'),
    ('Const_Hist_All', 'Todos'), ('Const_Msg_LimpHistorico',
    'Excluir el contenido entero del histórico ?'),
    ('Const_Msg_MensConfirma', 'Confirme'), ('Const_Msg_LogEmptyHistory',
    ...
    ('Const_Hist_FieldEvent', 'Event'), ('Const_Hist_FieldObs', 'Obs'),
    ('Const_Hist_FieldTableName', 'tName'), ('Const_Hist_MsgExceptPropr',
    'Por favor informe la propiedad %s'), ('Const_Hist_BtnFiltro', '&Aplicar Filtro'),
    ('Const_Hist_BtnExcluir', '&Borrar Histórico'), ('Const_Hist_BtnFechar', '&Cerrar'),
    ...
    ('Const_CadColuna_Computer', 'Computadora'), ('Const_CadColuna_Data', 'Data'),
...
const
  S_FRENCH: array [0 .. MaxArray, 0 .. 1] of string =
    ...
    ('Const_Contr_BtSelHint', 'Choisir'), ('Const_Contr_BtUnSelHint', 'No Choisir'),
    ...
    ('Const_MsgRec_BtClose', '&Près'), ('Const_MsgRec_WindowCaption', 'Message'),
    ('Const_MsgRec_Title', 'Message reçu'), ('Const_MsgRec_LabelFrom', 'De:'),
    ('Const_MsgRec_LabelDate', 'Date'), ('Const_MsgRec_LabelSubject', 'Sujet'),
    ('Const_MsgRec_LabelMessage', 'Message'), ('Const_MsgSend_BtSend', '&Envoyer'),
    ...
    ('Const_MsgSend_RadioAll', 'Tous'), ('Const_MsgSend_GroupMessage', 'Message'),
    ('Const_MsgSend_LabelSubject', 'Sujet'), ('Const_MsgSend_LabelMessageText',
    'Texte de message'), ('MsgExceptConnection',
    ...
    ('Const_Log_LabelSenha', 'Passe :'), ('Const_Log_LabelUsuario', 'Utilisateur :'),
    ...
    ('Const_LogC_WindowCaption', 'sécurité'), ('Const_LogC_LabelDescricao',
    'Rondin de système'), ('Const_LogC_LabelUsuario', 'Utilisateur :'),
    ('Const_LogC_LabelData', 'Date :'), ('Const_LogC_LabelNivel',
    'La moindre partie de niveau:'), ('Const_LogC_ColunaAppID', 'AppID'),
    ('Const_LogC_ColunaNivel', 'Niveau '), ('Const_LogC_ColunaMensagem', 'Message'),
    ('Const_LogC_ColunaUsuario', 'Utilisateur'), ('Const_LogC_ColunaData', 'Date'),
    ('Const_LogC_BtFiltro', '&Appliquez le Filtre'),
    ('Const_LogC_BtExcluir', '&Effacez le Rondin'), ('Const_LogC_BtFechar', '&Près'),
    ('Const_LogC_ConfirmaExcluir',
    ...
    ('Const_Cad_ColunaNome', 'Nom'), ('Const_Cad_ColunaLogin', 'Utilisateur'),
    ('Const_Cad_ColunaEmail', 'Courrier Électronique'),
    ('Const_Cad_BtAdicionar', '&Ajouter'), ('Const_Cad_BtAlterar', 'Ch&anger'),
    ('Const_Cad_BtExcluir', '&Effacer'), ('Const_Cad_BtPermissoes', 'A&pproches'),
    ('Const_Cad_BtSenha', '&Passe'), ('Const_Cad_BtFechar', '&Près'),
    ...
    ('Const_Prof_ColunaNome', 'Profile'), ('Const_Prof_BtAdicionar', '&Ajouter'),
    ...
    ('Const_PInc_LabelNome', 'Description :'), ('Const_PInc_BtGravar', '&Sauver'),
    ('Const_PInc_BtCancelar', 'Annuler'), ('Const_Perm_WindowCaption', 'Sécurité'),
    ('Const_Perm_LabelUsuario', 'Permissions de l''Utilisateur :'),
    ('Const_Perm_LabelPerfil', 'Permissions de l'' Profil :'),
    ('Const_Perm_PageMenu', 'Articles du Menu'), ('Const_Perm_PageActions', 'Actions'),
    ('Const_Perm_PageControls', 'Controls'), ('Const_Perm_BtLibera', '&Libération'),
    ('Const_Perm_BtBloqueia', '&Bloc'), ('Const_Perm_BtGravar', '&Sauver'),
    ('Const_Perm_BtCancelar', '&Annuler'), ('Const_Troc_WindowCaption', 'Sécurité'),
    ...
    ('Const_Troc_LabelConfirma', 'Confirmation :'), ('Const_Troc_BtGravar', '&Sauver'),
    ('Const_Troc_BtCancelar', 'Annuler'), ('Const_ErrPass_SenhaAtualInvalida',
    ...
    ('Const_Evento_Edit', 'Réviser'), ('Const_Evento_NewRecord', 'Nouveau record '),
    ('Const_Hist_All', 'Tous'), ('Const_Msg_LimpHistorico', 'Histoire de table propre?'),
    ('Const_Msg_MensConfirma', 'Confirmer'), ('Const_Msg_LogEmptyHistory',
    ...
    ('Const_Hist_FieldEvent', 'Event'), ('Const_Hist_FieldObs', 'Obs'),
    ('Const_Hist_FieldTableName', 'tName'), ('Const_Hist_MsgExceptPropr',
    'Informez la propriété %s'), ('Const_Hist_BtnFiltro', '&Appliquez le Filtre'),
    ('Const_Hist_BtnExcluir', '&Effacez l''Histoire'),
    ('Const_Hist_BtnFechar', '&Près'), ('Const_UserLogged_BtnMsg', '&Régénérez'),
    ...
    ('Const_CadColuna_Computer', 'Ordinateur'), ('Const_CadColuna_Data', 'Date'),
    ('Const_UserLogged_InputCaption', 'Message'),
...
const
  S_RUSSIAN: array [0 .. MaxArray, 0 .. 1] of utf8string =
    (('Const_Contr_TitleLabel', 'Team of Components of the Form. :'),
    ('Const_Contr_GroupLabel', 'Group:'), ('Const_Contr_CompDispLabel',
    'Available components:'), ('Const_Contr_CompSelLabel', 'Selected components:'),
    ('Const_Contr_BtOK', '&OK'), ('Const_Contr_BTCancel', '&Cancel'),
...
begin
  ...
  for I := 0 to MaxArray do
    begin
      case Lingua of
        ucPortuguesBr: if UpperCase(S_PORTUGALBR[I, 0]) = UpperCase(Prop) then
                         Result := UTF8Encode(S_PORTUGALBR[I, 1]);
        ucEnglish:     if UpperCase(S_ENGLISH[I, 0]) = UpperCase(Prop) then
                         Result := S_ENGLISH[I, 1];
        ucSpanish:     if UpperCase(S_SPANISH[I, 0]) = UpperCase(Prop) then
                         Result := S_SPANISH[I, 1];
        ucFrench:      if UpperCase(S_FRENCH[I, 0]) = UpperCase(Prop) then
                         Result := S_FRENCH[I, 1];
        ucRussian:     if UpperCase(S_RUSSIAN[I, 0]) = UpperCase(Prop) then
                         Result := S_RUSSIAN[I, 1];
        else
          if UpperCase(S_ENGLISH[I, 0]) = UpperCase(Prop) then
            Result := S_ENGLISH[I, 1];
      end;
    end;
end;
